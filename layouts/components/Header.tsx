...
const Header = () => {
  ...
  return (
    <Popover as="header" className="relative bg-white shadow">
                    ...
                    <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                      <div className="relative grid gap-6 px-5 py-6 bg-white sm:gap-8 sm:p-8 lg:grid-cols-2">
                        {solutions.map(solution => (
                          <a key={solution.name} href={solution.href} className="flex items-start p-3 -m-3 rounded-lg hover:bg-gray-50">
                    ...
                    <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                      <div className="relative grid gap-6 px-5 py-6 bg-white sm:gap-8 sm:p-8">
                        {resources.map(resource => (
                          <a key={resource.name} href={resource.href} className="block p-3 -m-3 rounded-md hover:bg-gray-50">
          ...
          <div className="bg-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 divide-gray-50">
            <div className="px-5 pt-5 pb-6">
              ...
              <div className="mt-6">
                <nav className="grid grid-cols-1 gap-7">
                  {solutions.map(solution => (
                    <a key={solution.name} href={solution.href} className="flex items-center p-3 -m-3 rounded-lg hover:bg-gray-50">
            ...
            <div className="px-5 py-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                {resources.map(resource => (
                  <a key={resource.name} href={resource.href} className="text-base font-medium text-gray-900 hover:text-gray-700">
                    {resource.name}
                  </a>
                ))}
              </div>
